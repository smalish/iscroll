...
var pop={wrap:null,mask:null,text:"",complete:null,determine:null,ok:null,cancel:null,determine_name:"",ok_name:"",cancel_name:"",speed:0,type:"",popup:function(a){if(!a.text)return!1;this.wrap=a.wrap?$(a.wrap):$(".popup");this.mask=a.mask?$(a.mask):$(".mask");this.title=a.title?a.title:"\u6e29\u99a8\u63d0\u793a";this.title_show=a.title_show;this.text=a.text;this.text_align="left"==a.text_align?"left":"right"==a.text_align?"right":"";this.complete="function"===typeof a.complete?a.complete:null;this.determine=
"function"===typeof a.determine?a.determine:null;this.ok="function"===typeof a.ok?a.ok:null;this.cancel="function"===typeof a.cancel?a.cancel:null;this.determine_name=a.determine_name?a.determine_name:"\u786e\u5b9a";this.ok_name=a.ok_name?a.ok_name:"\u786e\u5b9a";this.cancel_name=a.cancel_name?a.cancel_name:"\u53d6\u6d88";this.speed="number"===typeof a.speed&&0<a.speed?a.speed:2E3;if(a.type)switch(a.type.toLowerCase()){case "pop":this.type="Pop";break;case "confirm":this.type="Confirm";break;default:this.type=
"Alert"}else this.type="Alert";this.mask.css("display","none");this.wrap.css("display","none");this.wrap.removeClass("Pop Alert Confirm");this.wrap.find(".title").html("<span>"+this.title+"</span>").css("display","block").find("span").css("display","none");this.wrap.addClass(this.type).find(".info").removeClass("left right frame").addClass(this.text_align).html(this.text);this.wrap.find(".determine").html(this.determine_name).off("click").css("display","none");this.wrap.find(".ok").html(this.ok_name).off("click").css("display",
"none");this.wrap.find(".cancel").html(this.cancel_name).off("click").css("display","none");"Pop"===this.type?this.openPop():"Confirm"===this.type?this.openConfirm():this.openAlert();this.wrap.css({width:window.innerWidth+"px",height:window.innerHeight+"px",display:"block"})},openPop:function(){var a=this;a.wrap.find(".title").css("display","none");setTimeout(function(){a.wrap.css("display","none");a.complete&&a.complete()},a.speed)},openConfirm:function(){var a=this;a.mask.css("display","block");
a.title_show="undefined"!==typeof a.title_show?a.title_show?!0:!1:!1;a.title_show&&(a.wrap.find(".title span").css("display","block"),a.wrap.find(".info").addClass("frame"));a.wrap.find(".ok").css("display","block");a.wrap.find(".cancel").css("display","block");a.wrap.find(".ok").on("click",function(){a.mask.css("display","none");a.wrap.css("display","none");a.ok&&a.ok();a.complete&&a.complete()});a.wrap.find(".cancel").on("click",function(){a.mask.css("display","none");a.wrap.css("display","none");
a.cancel&&a.cancel();a.complete&&a.complete()})},openAlert:function(){var a=this;a.mask.css("display","block");a.title_show="undefined"!==typeof a.title_show?a.title_show?!0:!1:!0;a.title_show?a.wrap.find(".title span").css("display","block"):a.wrap.find(".info").addClass("frame");a.wrap.find(".determine").css("display","block");a.wrap.find(".determine").on("click",function(){a.mask.css("display","none");a.wrap.css("display","none");a.determine&&a.determine();a.complete&&a.complete()})}},$_GET=function(){var a=
window.document.location.href.toString().split("?");if("string"==typeof a[1]){-1!=a[1].indexOf("#")?(a=a[1].split("#"),a=a[0].split("&")):a=a[1].split("&");var c={},b;for(b in a){var d=a[b].split("=");c[d[0]]=d[1]}return c}return{}}();
